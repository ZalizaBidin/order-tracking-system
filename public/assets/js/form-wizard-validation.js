...
(function () {
  ...
  if (typeof wizardValidation !== undefined && wizardValidation !== null) {
    ...
    // Wizard steps
    const wizardValidationFormStep1 = wizardValidationForm.querySelector('#programme-validation');
    const wizardValidationFormStep2 = wizardValidationForm.querySelector('#fixed-cost-validation');
    const wizardValidationFormStep3 = wizardValidationForm.querySelector('#variable-cost-validation');
    const wizardValidationFormStep4 = wizardValidationForm.querySelector('#summary-validation');
    ...
    const FormValidation1 = FormValidation.formValidation(wizardValidationFormStep1, {
      fields: {
        ...
        prog_name: {
          validators: {
            notEmpty: {
              message: 'The Programme Name is required'
            }
          }
        },
        no_stud: {
