                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-outline-primary btn-sm" target="_blank"
                                ...
                                <i class="bi bi-map me-1"></i> View Customer Location
                            </a>
                            @else
                            <span class="text-muted">No GPS location provided</span>
                            @endif
                        </td>
                    </tr>
...
<script>
    function getLocation() {
        ...
        if (!navigator.geolocation) {
            status.innerHTML = '<span class="text-danger">GPS is not supported by this browser.</span>';
            return;
        }

        status.innerHTML = '<span class="text-muted">Getting current location...</span>';
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            function() {
                status.innerHTML = '<span class="text-danger">Unable to retrieve your location. Please allow location permission.</span>';
            }
        );
    }
</script>
